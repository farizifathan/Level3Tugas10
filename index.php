      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">Arkademy Produk</font></span></a>
            </center>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Produk<span class="fa fa-chevron-down"></span></a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Arkademy Pr : Farizi Fathan Pane
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
